		    ...
		    <h1>Parte 2: Leitores de tela</h1>
			    ...
			    <form name="parte2" class="usa-form-large" action="{{ url('/parte2') }}" method="post">
			      <fieldset>
			        ...
			        <label for="ldt-atualizar" id="atualizar">2.3 Quando foi a última vez que você atualizou seu leitor de tela para computador / notebook?</label>
			        ...
			        <label for="ldt-mobile" id="mobile">2.4 Qual leitor de tela você mais utiliza para celular / tablet?</label>
			        ...
			        <label for="uso-recurso" id="uso">2.5 Qual opção descreve como você utiliza o seu leitor de tela?</label>
			        ...
			        <label for="uso-dispositivo" id="dispositivo">2.6 Você utiliza mais computador / notebook ou do celular / tablet?</label>
			        ...
			        <label for="aprendeu" id="aprende">2.7 Como você aprendeu a utilizar seu leitor de tela?</label>
			        ...
			        <label for="pagar" id="pg">2.8 Você acha que vale a pena pagar por um leitor de tela?</label>
			        ...
			        <label for="pagar-porque" id="pgto">2.9 Explique o motivo da resposta acima.</label>
