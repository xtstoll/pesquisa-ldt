...
<main>
    ...
    <form class="usa-form-large">
      <fieldset>
        ...
        <select name="navegador-desktop" id="navegador-desktop" required>
            ...
            <option value="navegador-desktop-naoutilizo">Não utilizo nenhum</option>
       </select>

        <label for="navegador-mobile">3.2 Qual navegador você mais utiliza no seu celular / tablet?</label>    
        <select name="navegador-mobile" id="navegador-mobile" required>
            <option value>Selecione</option>
            ...
            <option value="navegador-mobile-naoutilizo">Não utilizo nenhum</option>
        </select>
        ...
        <select name="nav-encontrar" id="nav-encontrar" required>
            <option value>Selecione</option>
        ...
        <select name="nav-irpara" id="nav-irpara" required>
            <option value>Selecione</option>
        ...
        <select name="nav-marcas" id="nav-marcas" required>
            <option value>Selecione</option>
        ...
        <select name="nav-barra" id="nav-barra" required>
            <option value>Selecione</option>
        ...
        <select name="nav-teclas" id="nav-teclas" required>
            <option value>Selecione</option>
        ...
        <select name="nav-dificil" id="nav-dificil" required>
            <option value>Selecione</option>
