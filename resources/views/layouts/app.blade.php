			      ...
			      <fieldset>
			    	...
			    	<label id="Deficiencias">1.5 Qual(is) deficiência(s) você possui?</label>
			    	 <ul class="usa-unstyled-list">
			    	    ...
			    	    <li>
			    	      <input id="deficienciaauditiva" type="checkbox" name="deficiencia[]" value="auditiva" role="checkbox" onclick="CHK();" onKeyPress="CHK();" aria-label="deficiência auditiva não selecionado">
