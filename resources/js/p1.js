...
document.getElementById("ano").innerHTML='<label for="ano_nascimento" id="ano" role="alert"> Ano de Nascimento Inválido. -  1.1 Qual ano você nasceu?</label>';
return false;
}
else if(genero=="")
{
parte1.genero.focus();
document.getElementById("gen").innerHTML='<label for="genero" id="gen"  role="alert">Por favor, selecione uma opção abaixo. - 1.2 Qual é o seu gênero?</label>';
return false;
}
else if(estado=="")
{
