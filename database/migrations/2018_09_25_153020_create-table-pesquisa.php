...
class CreateTablePesquisa extends Migration
{
    ...
    public function up()
    {
        Schema::create('respostas', function (Blueprint $table) {
            ...
            $table->boolean("def_cegueira")->default(false);
            $table->boolean("def_bx_visao")->default(false);
            $table->boolean("def_cognitiva")->default(false);
            $table->boolean("def_auditiva")->default(false);
            $table->boolean("def_motora")->default(false);
            $table->boolean("def_outra")->default(false);
            $table->boolean("def_nenhuma")->default(false);
